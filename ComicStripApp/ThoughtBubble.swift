...
@IBDesignable class ThoughtBubble : BaseDialogBubble {
    ...
    override func drawBackgroundShapes(width: CGFloat, height: CGFloat) -> (shapes: [CAShapeLayer], mainBubblePath: UIBezierPath) {
        ...
        bezier4Path.move(to: CGPoint(x: (width * 0.1611), y: (height * 0.3870)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1232), y: (height * 0.4630)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1473), y: (height * 0.5478)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.2037), y: (height * 0.5975)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.2894), y: (height * 0.5935)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.3434), y: (height * 0.5584)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.3799), y: (height * 0.5701)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4272), y: (height * 0.5649)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4576), y: (height * 0.5620)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4665), y: (height * 0.5079)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5115), y: (height * 0.5048)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5115), y: (height * 0.5412)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5583), y: (height * 0.5549)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5980), y: (height * 0.5117)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5889), y: (height * 0.4243)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.6226), y: (height * 0.4049)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.6632), y: (height * 0.5027)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.7350), y: (height * 0.5098)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8145), y: (height * 0.4752)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8590), y: (height * 0.4202)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8570), y: (height * 0.3642)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8369), y: (height * 0.3053)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8908), y: (height * 0.2943)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.9188), y: (height * 0.3542)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.9514), y: (height * 0.2816)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.9063), y: (height * 0.2484)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8863), y: (height * 0.1889)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.8427), y: (height * 0.1347)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.7783), y: (height * 0.1109)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.7231), y: (height * 0.1207)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.6921), y: (height * 0.1568)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.6627), y: (height * 0.1457)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.6382), y: (height * 0.0913)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5775), y: (height * 0.0548)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.5132), y: (height * 0.0567)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4913), y: (height * 0.0811)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4751), y: (height * 0.1057)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4463), y: (height * 0.0897)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.4158), y: (height * 0.0745)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.3661), y: (height * 0.0785)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.3357), y: (height * 0.0979)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.3113), y: (height * 0.1279)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.2772), y: (height * 0.1700)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.2375), y: (height * 0.1771)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.2530), y: (height * 0.1200)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1971), y: (height * 0.1180)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1499), y: (height * 0.1461)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1279), y: (height * 0.1886)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1080), y: (height * 0.2495)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.0963), y: (height * 0.2823)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.0630), y: (height * 0.2901)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.0614), y: (height * 0.3485)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.0782), y: (height * 0.3965)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1123), y: (height * 0.3948)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1617), y: (height * 0.3530)))
        bezier4Path.addLine(to: CGPoint(x: (width * 0.1611), y: (height * 0.3870)))
        bezier4Path.close()

        return (
            shapes: [shape, shape2, ovalShape, oval2Shape, oval3Shape, oval4Shape, oval5Shape, oval6Shape],
            mainBubblePath: bezier4Path)
    }
