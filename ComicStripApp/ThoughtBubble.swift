...
@IBDesignable class ThoughtBubble : BaseDialogBubble {
    ...
    override func getExclusionPath(width: CGFloat) -> UIBezierPath {
        ...
        bezier3Path.addCurve(to: CGPoint(x: (width * 0.9518), y: (width * 0.3072)), controlPoint1: CGPoint(x: (width * 0.9518), y: (width * 0.2620)), controlPoint2: CGPoint(x: (width * 0.9546), y: (width * 0.2884)))
        bezier3Path.addCurve(to: CGPoint(x: (width * 0.8464), y: (width * 0.3072)), controlPoint1: CGPoint(x: (width * 0.9512), y: (width * 0.3058)), controlPoint2: CGPoint(x: (width * 0.8464), y: (width * 0.3072)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.8464), y: (width * 0.4247)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.5512), y: (width * 0.4247)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.5512), y: (width * 0.5060)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.1747), y: (width * 0.5060)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.1747), y: (width * 0.3614)))
        bezier3Path.addCurve(to: CGPoint(x: (width * 0.0663), y: (width * 0.3614)), controlPoint1: CGPoint(x: (width * 0.1745), y: (width * 0.3619)), controlPoint2: CGPoint(x: (width * 0.0663), y: (width * 0.3614)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.0663), y: (width * 0.2620)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.1145), y: (width * 0.2620)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.1145), y: (width * 0.1837)))
        bezier3Path.addCurve(to: CGPoint(x: (width * 0.1355), y: (width * 0.1627)), controlPoint1: CGPoint(x: (width * 0.1145), y: (width * 0.1837)), controlPoint2: CGPoint(x: (width * 0.1232), y: (width * 0.1795)))
        bezier3Path.addCurve(to: CGPoint(x: (width * 0.2681), y: (width * 0.1627)), controlPoint1: CGPoint(x: (width * 0.1359), y: (width * 0.1633)), controlPoint2: CGPoint(x: (width * 0.2681), y: (width * 0.1627)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.3283), y: (width * 0.1627)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.3283), y: (width * 0.0964)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.6325), y: (width * 0.0964)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.6325), y: (width * 0.1627)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.6807), y: (width * 0.1627)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.8855), y: (width * 0.1627)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.8855), y: (width * 0.2620)))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: (width * 1.0000), y: (width * 0.0000)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.0000), y: (width * 0.0000)))
        bezier3Path.addLine(to: CGPoint(x: (width * 0.0000), y: (width * 1.0000)))
        bezier3Path.addLine(to: CGPoint(x: (width * 1.0000), y: (width * 1.0000)))
        bezier3Path.addLine(to: CGPoint(x: (width * 1.0000), y: (width * 0.0000)))
        bezier3Path.close()
        return bezier3Path
    }
